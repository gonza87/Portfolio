        ...
        <section id="proyectos" className="proyectos">
          ...
          <div className="d-flex flex-wrap justify-content-between ">
            <Card className="cardProyectos" style={{ width: "18rem" }}>
              <Card.Img variant="top" src="/img/Untitled.gif" />
              <Card.Body>
            ...
            <Card className="cardProyectos" style={{ width: "18rem" }}>
              <Card.Img variant="top" src="/img/hackflix.JPG" />
              <Card.Body>
            ...
            <Card className="cardProyectos" style={{ width: "18rem" }}>
              <Card.Img variant="top" src="/img/tweter.JPG" />
              <Card.Body>
            ...
            <Card className="cardProyectos" style={{ width: "18rem" }}>
              <Card.Img variant="top" src="/img/todosurfjs.JPG" />
              <Card.Body>
            ...
            <Card className="cardProyectos" style={{ width: "18rem" }}>
              <Card.Img variant="top" src="/img/todosurf.JPG" />
              <Card.Body>
                <Card.Title className="titleCardProyect">TodoSurf</Card.Title>
                <Card.Text className="textCardProyect">
                  React Node Express
